...
repaired the F18-A.1 candidate's external-review finding: stale
recorded census/test counts ("22 per-city"/"38 extras"/"+9 tests"
→ measured 21/28/+21) in `environment.md`, `LAST_ITERATION.md`
and the F18-A.1 row; implementation untouched, `751485d`'s
commit-message wording disclosed rather than rewritten.
