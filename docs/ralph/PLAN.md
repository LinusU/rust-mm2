...
(player-hit feel/damage legs), F13-C, the F18-A remainder, or the F07-B remainder
(scrape + audible
evidence))** — the latest iteration landed F10-B.13, the
