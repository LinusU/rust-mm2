...
| F22-B | active | F22-A | Split into B.1 (authored cockpit/dash view — implemented above) and B.2 (rear-view mirror strip + F4 rebinding — implemented above); the occlusion handling and chase-near/far pair remainder stays open. |
| F22-C | queued | F22-B | — |
