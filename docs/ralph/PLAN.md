...
**Next selected slice: decal stamping research (same
research-first caveat as prop rules), the hull-clearance fidelity
question, F13-A or F09-C** — iteration 35 landed F03-B.3: the
