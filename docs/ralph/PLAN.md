...
`ImpactsTable` texel damage + `asLineSparks` sparks — needs a
contact-point feed, damage-driven detachment if original, C&R
healing driver — needs F27's mode),
