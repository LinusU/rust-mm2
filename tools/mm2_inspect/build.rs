//! Embed the engine commit into `mm2-inspect` so generated reports are
//! versioned by the exact code that produced them (F00 requirement: keep
//! coverage reports versioned by engine commit).
