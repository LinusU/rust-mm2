...
pub use traffic::{
    AmbientPlan, AmbientRoster, AmbientSpec, LaneAdvance, LaneCursor, SpawnDirective, SpawnDraw,
    SpawnPolicy, TrafficIssue, advance_lane_cursor, draw_spawn, eligible_lanes, plan_ambient,
};
